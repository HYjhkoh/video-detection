...
input_size = 300
model = dict(
    type='SingleStageDetectorCorr_resize',
    pretrained='pretrained/ssd300_vid.pth',
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=[
                ...
                data_root + 'VID/ImageSets/Main/train_1img2.txt'
            ],
            seq_len=4,
            img_prefix=[
                # data_root + 'DET/train/',
...
log_level = 'INFO'
work_dir = './work_dirs/jkkim/ssd300_corr5_lstm_resize'
load_from = None
resume_from = './work_dirs/jkkim/ssd300_corr5_lstm_resize/epoch_34.pth'
workflow = [('train', 1)]
