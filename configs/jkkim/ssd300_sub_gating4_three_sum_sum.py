...
input_size = 300
model = dict(
    type='SingleStageDetectorPixelMotion_three_sub',
    ...
    neck=None,
    pixel=dict(
        type='PixelGatingonce_three2_sum',
    ...
    motion=dict(
        ...
        upsample_param=2),
    bbox_head=dict(
        type='SSDHeadPixelMotion_three_sub_sum',
        input_size=input_size,
        in_channels=(512, 1024, 512, 256, 256, 256),
        num_classes=31,
...
log_level = 'INFO'
work_dir = './work_dirs/jhkoh/ssd300_sub_gating4_three_sum_sum/'
load_from = None
resume_from = ''
workflow = [('train', 1)]