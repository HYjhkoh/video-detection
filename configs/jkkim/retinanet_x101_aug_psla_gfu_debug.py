...
test_cfg = dict(
    ...
    max_per_img=100,
    video_mode=False) # if True, Seq-nms
# dataset settings
...
log_level = 'INFO'
work_dir = './work_dirs/det30_vid15/retinanet_x101_aug_psla_gfu_50'
load_from = None
resume_from = './work_dirs/det30_vid15/retinanet_x101_aug_psla_gfu_50/latest.pth'
workflow = [('train', 1)]
