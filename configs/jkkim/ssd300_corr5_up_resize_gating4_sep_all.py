...
input_size = 300
model = dict(
    type='SingleStageDetectorPixelMotion',
    ...
    neck=None,
    pixel=dict(
        type='PixelGatingseperate_all',
        in_channels=(512, 1024, 512, 256, 256, 256),
        gating_seq_len=4),
    motion=dict(
        type='CorrLSTM_upsample_resize',
        in_channels=(512, 1024, 512, 256, 256, 256),
        corr_size=5,
        upsample_param=2),
    bbox_head=dict(
        type='SSDHeadPixelMotion',
        input_size=input_size,
        in_channels=(512, 1024, 512, 256, 256, 256),
        num_classes=31,
        corr_size=5,
...
log_level = 'INFO'
work_dir = './work_dirs/jkkim/ssd300_corr5_up_resize_gating4_seperate_all/'
load_from = None
resume_from = ''
workflow = [('train', 1)]