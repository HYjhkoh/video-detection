...
log_level = 'INFO'
work_dir = './work_dirs/det30_vid15/ssd300_corr5_lstm_depth'
load_from = None
resume_from = './work_dirs/det30_vid15/ssd300_corr5_lstm_depth/epoch_24.pth'
workflow = [('train', 1)]
