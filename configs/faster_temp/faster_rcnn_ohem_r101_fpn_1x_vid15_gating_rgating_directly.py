...
model = dict(
    ...
    temporal=dict(
        ...
        gating_seq_len=4),
    temporal2=dict(
        type='PixelGatingonce_three2_roi',
        in_channels=(256,),
        gating_seq_len=4),
    rpn_head=dict(
        type='RPNHead',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_temp/faster_rcnn_r101_fpn_1x_vid15_ohem_8_gating_rgating_directly'
load_from = None
resume_from = './work_dirs/faster_temp/faster_rcnn_r101_fpn_1x_vid15_ohem_8_gating_rgating_directly/epoch_3.pth'
workflow = [('train', 1)]