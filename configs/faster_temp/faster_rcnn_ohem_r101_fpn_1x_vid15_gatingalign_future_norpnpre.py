...
model = dict(
    type='FasterRCNNTemp',
    pretrained='pretrained/faster_101_gatingalign_norpn.pth',
    backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
log_level = 'INFO'
work_dir = './work_dirs/faster_temp/faster_rcnn_r101_fpn_1x_vid15_ohem_8_gatingalign_future_fromdet200_norpn'
load_from = None
resume_from = ''
workflow = [('train', 1)]
