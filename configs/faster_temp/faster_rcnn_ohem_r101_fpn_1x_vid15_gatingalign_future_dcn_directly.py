...
log_level = 'INFO'
work_dir = './work_dirs/faster_temp/dcn/faster_rcnn_r101_fpn_1x_vid15_ohem_8_gatingalign_future'
load_from = None
resume_from = './work_dirs/faster_temp/faster_rcnn_r101_fpn_1x_vid15_ohem_8_gatingalign_future/epoch_1.pth'
workflow = [('train', 1)]
