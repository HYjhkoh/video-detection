...
model = dict(
    ...
    temporal=dict(
        ...
        corr_size=5),
    temporal2=dict(
        type='PixelGatingAlignFutureRoi',
        in_channels=(256, 256, 256, 256, 256),
        gating_seq_len=5,
        corr_size=5),
    rpn_head=dict(
...
log_level = 'INFO'
work_dir = './work_dirs/faster_temp/faster_rcnn_r101_fpn_1x_vid15_ohem_8_ga_rga_fixed_future2'
load_from = None
resume_from = './work_dirs/faster_temp/faster_rcnn_r101_fpn_1x_vid15_ohem_8_ga_rga_fixed_future2/epoch_7.pth'
workflow = [('train', 1)]