...
class RetinaHeadCorr_depth(AnchorHeadCorr):
    ...
    def __init__(self,
        ...
        super(RetinaHeadCorr_depth, self).__init__(
    ...
    def _init_layers(self):
        ...
        self.depth_states = nn.Conv2d(self.corr_size*self.corr_size, self.in_channels, kernel_size=3, padding=1)
    ...
    def forward_single(self, x_corr, x):
        # pdb.set_trace()
        x_corr = self.relu(self.depth_states(x_corr))
        feat = torch.cat([x, x_corr], 1)
