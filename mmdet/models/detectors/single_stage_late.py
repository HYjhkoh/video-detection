...
class SingleStageDetectorLate(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(SingleStageDetectorLate, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorLate, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        x_temp = self.temporal(outs_pre, x)
