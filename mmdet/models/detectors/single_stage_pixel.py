...
class SingleStageDetectorPixel(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(SingleStageDetectorPixel, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorPixel, self).init_weights(pretrained)
