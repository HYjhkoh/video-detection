...
class SingleStageDetectorPixelMotion_three(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 corr_size=None,
                 gating_seq_len=None):
        super(SingleStageDetectorPixelMotion_three, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorPixelMotion_three, self).init_weights(pretrained)
