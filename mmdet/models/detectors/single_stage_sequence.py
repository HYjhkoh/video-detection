...
class SingleStageDetectorSequence(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 gating_seq_len=None):
        super(SingleStageDetectorSequence, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorSequence, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        # x_temp = self.temporal([x_all[seq_len-self.gating_seq_len+i] for i in range(self.gating_seq_len)])

        outs = self.bbox_head(x_all[-1])
