...
class SingleStageDetectorPixelMotionCorr(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 corr_size=None,
                 gating_seq_len=None):
        super(SingleStageDetectorPixelMotionCorr, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorPixelMotionCorr, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        x_motion = self.motion(x_all[-2], x_all[-1])
