...
class TwoStageDetectorPixel(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetectorPixel, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetectorPixel, self).init_weights(pretrained)
        ...
        if self.with_rpn:
            self.rpn_head.init_weights(pretrained=pretrained)
        if self.with_bbox:
    ...
    def feature_vis(self, img, features):
        ...
        cv2.imwrite('./vis_feature/faster/input_image5.png', inputs[4])
        pdb.set_trace()
