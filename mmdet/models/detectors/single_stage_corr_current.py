...
class SingleStageDetectorCorr_current(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 in_channels=None,
                 corr_size=None):
        super(SingleStageDetectorCorr_current, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorCorr_current, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        for i in range(seq_len-1):
            multi_init_state = self.temporal(x_all[i], x_all[-1], multi_init_state)
