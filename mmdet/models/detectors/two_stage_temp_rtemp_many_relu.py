...
class TwoStageDetectorTempRTempManyRelu(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetectorTempRTempManyRelu, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetectorTempRTempManyRelu, self).init_weights(pretrained)
