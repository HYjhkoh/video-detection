...
class SingleStageDetectorMotion(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(SingleStageDetectorMotion, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorMotion, self).init_weights(pretrained)
