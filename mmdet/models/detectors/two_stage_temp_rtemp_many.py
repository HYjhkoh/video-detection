...
class TwoStageDetectorTempRTempMany(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetectorTempRTempMany, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetectorTempRTempMany, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        if self.with_rpn:
            ...
            proposal_cfg = self.train_cfg.get('rpn_proposal',
                                              self.test_cfg.rpn)
            proposal_inputs = rpn_out_cur + (img_meta, proposal_cfg, [0], 'True')
