...
class SingleStageDetectorPixelMotion_three_sub(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 gating_seq_len=None):
        super(SingleStageDetectorPixelMotion_three_sub, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorPixelMotion_three_sub, self).init_weights(pretrained)
