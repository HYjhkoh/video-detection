...
class SingleStageDetectorLSTM_l1loss(BaseDetectorTemp):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 cur=None):
        super(SingleStageDetectorLSTM_l1loss, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorLSTM_l1loss, self).init_weights(pretrained)
